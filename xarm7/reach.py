...
from xArm7.envs.xarm7_env import XArm7  # Assuming you have such a base environment


MODEL_XML_PATH = os.path.join(os.path.dirname(__file__), "../assets/", "xarm7_reach.xml")

class XArm7ReachEnv(XArm7):
    def __init__(
        self,
    ...
    def _render_callback(self) -> None:
        ...
        site_id = self._model_names.site_name2id["target_xarm7"]
